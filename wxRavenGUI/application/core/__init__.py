...
wxcomponent aim to regroup all the wx elements inherited from the WxDesign made externally
in add the Logic behind the GUI elements and fix what designed can't do.

'''

from .rpcConnectorManager import *
...
from wxRavenGUI.application.core.wxTaskBarManager import *
