...
class wxRavenPlugin(PluginObject):
    ...
    def __init__(self, parentFrame, position="mgr"):
        ...
        self.PLUGIN_NAME = "ProfileManager"
        self.PLUGIN_ICON = self.RessourcesProvider.GetImage('UserAccount_custom') #wx.Bitmap( u"res/default_style/normal/help_view.png", wx.BITMAP_TYPE_ANY )
        ...
        self.PLUGINS_VIEWS= [ 
                    {
                     'viewid':'Profile Selector', 
                     'name':'Profile Selector', 
                     'title':'Select a Profile :', 
                     'position': 'dialog', 
                     'icon':self.PLUGIN_ICON, 
                     'class': wxRavenProfileManager_ProfileSelectorLogic ,
                     'default':False,
                     'multipleViewAllowed':False
                     },
                    
                    {
                     'viewid':'Dialofg Selector', 
                     'name':'Dialofg Selector', 
                     'title':'Select a Profile :', 
                     'position': 'dialog', 
                     'icon':self.PLUGIN_ICON, 
                     'class': wxRavenProfileManager_ProfileSelectorDialogLogic ,
                     'default':False,
                     'multipleViewAllowed':False
                     },
