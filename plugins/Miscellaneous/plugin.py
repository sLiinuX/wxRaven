...
class wxRavenPlugin(PluginObject):
    ...
    def __init__(self, parentFrame, position="mgr"):
        ...
        self.PLUGIN_NAME = "Miscellaneous"
        self.PLUGIN_ICON = self.RessourcesProvider.GetImage('tools') #wx.Bitmap( u"res/default_style/normal/help_view.png", wx.BITMAP_TYPE_ANY )
        ...
        self.PLUGINS_VIEWS= [ 
                    ...
                    ,
                     ...
                     'position':'dialog', 
                     'icon':_airdrop, 
                     'class': wxRavenMiscellaneous_CreateAirdropWithLogic, 
                     'default':False,
                     'multipleViewAllowed':False,
                     'toolbar_shortcut': True
                     }
                     ...
                     'toolbar_shortcut': True
                      ...
                      {
                     'viewid':"Monitoring Panel", 
                     'name':"Monitoring Panel", 
                     'title':"Monitoring Panel", 
                     'position':position, 
                     'icon':self.RessourcesProvider.GetImage('monitoring_dashboard_2'), 
                     'class': wxRavenMiscellaneous_NodeMonitorLogic ,
                     'default':False,
                     'multipleViewAllowed':False, 
                     },
